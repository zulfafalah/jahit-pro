...
class AppColors {
  ...
  static const Color onSecondaryContainer = Color(0xFF007327);

  static const Color tertiary = Color(0xFF6C3100);
  static const Color tertiaryContainer = Color(0xFF904300);
